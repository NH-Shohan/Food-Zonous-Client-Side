      ...
      {isLoading ? (
        ...
        <>
                ...
                <div>
                  ...
                  <div className="carousel-item">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                      <h1>
                        Good Food{" "}
                        <span className="text-warning">Good Life</span>
                      </h1>
                    </div>
                  </div>
                  <div className="carousel-item">
          ...
          <section className="container mb-5 mt-5">
            <h3 className="text-dark mt-2">Testimonials</h3>
            <h1 className="mt-2">
              <span className="text-warning fs-1">“</span> Why Our Clients
              <span className="text-warning fs-1 ms-3">Choose Us</span>”
            </h1>

            <div
              id="carouselExampleCaptions"
              className="carousel slide mt-5 mb-5 w-75 m-auto"
              data-bs-ride="carousel"
            >
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  ...
                  <p>
                    ...
                    products to Asia from around the World. "All our products
                    are made with prime ingredients that are selected with care
                    by our renowned partner brands"
                  </p>
                </div>
                <div className="carousel-item ">
                  ...
                  <p>
                    ...
                    according to British Retail Consortium Global Standards
                    (BRC), Hazard Critical Control Points (HACCP) and
                ...
                <div className="carousel-item ">
                  ...
                  <p>
                    Our products are the perfect companion for Chef's
                    Creativity. Finished or semi-finished, all our products are
                    easy to handle and ready to be customized following the
                    Chef's inspiration. As we only work with top food producers,
                    quality is consistent all year long.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="container mb-5 mt-5">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <i className="fas fa-cookie-bite mt-5 mb-4"></i>
